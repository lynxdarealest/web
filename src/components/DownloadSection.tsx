        ...
        {DOWNLOAD_OPTIONS.map((item) => (
          item.link ? (
            <a
              ...
              className="bg-card border border-border p-4 rounded-lg text-center cursor-pointer hover:border-primary hover:bg-[#252533] transition-all group block"
            >
              ...
              <span className="mt-2 inline-flex rounded-full border border-border px-2 py-1 text-[10px] uppercase text-primary bg-primary/10">
                {item.label}
              </span>
            </a>
          ) : (
